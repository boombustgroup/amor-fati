...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/exact_SFC_identities-13-orange.svg" alt="13 exact SFC identities">
...
Amor Fati is a **stock-flow consistent** (SFC) **agent-based model** (ABM) that simulates the Polish economy at the level of individual households, heterogeneous firms, and a realistic multi-bank financial system. The engine enforces 13 exact accounting identities each month — if a single zloty goes missing, the simulation fails.
...
- SFC validation must preserve 13 exact semantic accounting identities
